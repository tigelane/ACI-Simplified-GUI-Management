...
RUN git clone https://github.com/tigelane/aci_legacy_tenant_epg.git devnet-create-2020/repos/dc_2020_aci_legacy_tenant
RUN git clone https://github.com/tigelane/aci_appliance_server.git devnet-create-2020/repos/dc_2020_aci_appliance_server
